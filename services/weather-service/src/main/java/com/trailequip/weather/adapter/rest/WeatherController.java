...
public class WeatherController {
    ...
    public ResponseEntity<Map<String, Object>> getForecast(
        ...
        Map<String, Object> forecast = weatherService.getForecast(lat, lon,
                LocalDate.parse(startDate), LocalDate.parse(endDate), timezone);
    ...
    public ResponseEntity<Map<String, Object>> listProviders() {
        return ResponseEntity.ok(Map.of(
            "providers", new Object[]{
                Map.of("id", "open-meteo", "name", "Open-Meteo", "status", "active")
            }
        ));
    }
}
